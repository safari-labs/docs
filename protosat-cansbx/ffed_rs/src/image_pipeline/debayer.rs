...
impl CudaDebayer {
    ...
    #[allow(unused)]
    pub fn process(&self, _raw_image: &RawImageData) -> anyhow::Result<RgbImageData> {
        Err(anyhow::anyhow!("CUDA debayer is not available on this platform."))
    }
}
...
impl NppDebayer {
    ...
    #[allow(unused)]
    pub fn process(&self, _raw_image: &RawImageData) -> anyhow::Result<RgbImageData> {
        Err(anyhow::anyhow!("NPP debayer is not available on this platform."))
    }
}
